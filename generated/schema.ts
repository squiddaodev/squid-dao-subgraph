...
export class Managed extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save Managed entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Managed entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("Managed", id.toString(), this);
  }

  static load(id: string): Managed | null {
    return store.get("Managed", id) as Managed | null;
  }
...
export class ProtocolMetric extends Entity {
  ...
  get managed(): BigDecimal {
    let value = this.get("managed");
    return value.toBigDecimal();
  }

  set managed(value: BigDecimal) {
    this.set("managed", Value.fromBigDecimal(value));
  }
  ...
  get treasuryEthRiskFreeValue(): BigDecimal {
    let value = this.get("treasuryEthRiskFreeValue");
    return value.toBigDecimal();
  }

  set treasuryEthRiskFreeValue(value: BigDecimal) {
    this.set("treasuryEthRiskFreeValue", Value.fromBigDecimal(value));
  }
  ...
  get treasurySquidEthPOL(): BigDecimal {
    let value = this.get("treasurySquidEthPOL");
    return value.toBigDecimal();
  }

  set treasurySquidEthPOL(value: BigDecimal) {
    this.set("treasurySquidEthPOL", Value.fromBigDecimal(value));
  }
...
export class BondDiscount extends Entity {
  ...
  get weth_discount(): BigDecimal {
    let value = this.get("weth_discount");
    return value.toBigDecimal();
  }

  set weth_discount(value: BigDecimal) {
    this.set("weth_discount", Value.fromBigDecimal(value));
  }

  get squideth_discount(): BigDecimal {
    let value = this.get("squideth_discount");
    return value.toBigDecimal();
  }

  set squideth_discount(value: BigDecimal) {
    this.set("squideth_discount", Value.fromBigDecimal(value));
  }
}
