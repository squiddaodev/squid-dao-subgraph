...
export class CurvePool extends ethereum.SmartContract {
  ...
  try_balances(i: BigInt): ethereum.CallResult<BigInt> {
  ...
  calc_token_amount(amounts: Array<BigInt>, is_deposit: boolean): BigInt {
    let result = super.call(
      "calc_token_amount",
      "calc_token_amount(uint256[2],bool):(uint256)",
      [
        ethereum.Value.fromUnsignedBigIntArray(amounts),
        ethereum.Value.fromBoolean(is_deposit)
      ]
    );
  ...
  admin_balances(arg0: BigInt): BigInt {
    let result = super.call(
      "admin_balances",
  ...
  try_admin_balances(arg0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "admin_balances",
      "admin_balances(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
