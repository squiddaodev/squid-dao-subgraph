...
export class BondDepository__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BondDepository__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BondDepository__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class BondDepository extends ethereum.SmartContract {
  static bind(address: Address): BondDepository {
    return new BondDepository("BondDepository", address);
  }
  ...
  adjustment(): BondDepository__adjustmentResult {
    ...
    return new BondDepository__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<BondDepository__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BondDepository__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): BondDepository__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new BondDepository__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<BondDepository__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BondDepository__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): BondDepository__termsResult {
    let result = super.call(
      "terms",
    ...
    return new BondDepository__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<BondDepository__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BondDepository__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
