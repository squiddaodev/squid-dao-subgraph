...
export class NewCollateralCap extends ethereum.Event {
  get params(): NewCollateralCap__Params {
    return new NewCollateralCap__Params(this);
  }
}

export class NewCollateralCap__Params {
  _event: NewCollateralCap;

  constructor(event: NewCollateralCap) {
    this._event = event;
  }
...
export class UserCollateralChanged extends ethereum.Event {
  get params(): UserCollateralChanged__Params {
    return new UserCollateralChanged__Params(this);
  }
}

export class UserCollateralChanged__Params {
  _event: UserCollateralChanged;

  constructor(event: UserCollateralChanged) {
    this._event = event;
  }
  ...
  get newCollateralTokens(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }
}

export class cyToken__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class cyToken extends ethereum.SmartContract {
  static bind(address: Address): cyToken {
    return new cyToken("cyToken", address);
  }

  EVIL_SPELL(): Address {
    let result = super.call("EVIL_SPELL", "EVIL_SPELL():(address)", []);

    return result[0].toAddress();
  }

  try_EVIL_SPELL(): ethereum.CallResult<Address> {
    let result = super.tryCall("EVIL_SPELL", "EVIL_SPELL():(address)", []);
    if (result.reverted) {
  ...
  accountCollateralTokens(param0: Address): BigInt {
    let result = super.call(
      "accountCollateralTokens",
      "accountCollateralTokens(address):(uint256)",
  ...
  try_accountCollateralTokens(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "accountCollateralTokens",
      "accountCollateralTokens(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  collateralCap(): BigInt {
    let result = super.call("collateralCap", "collateralCap():(uint256)", []);

    return result[0].toBigInt();
  }

  try_collateralCap(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "collateralCap",
      "collateralCap():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  estimateBorrowRatePerBlockAfterChange(
    ...
    let result = super.call(
      "estimateBorrowRatePerBlockAfterChange",
      "estimateBorrowRatePerBlockAfterChange(uint256,bool):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(change),
        ethereum.Value.fromBoolean(repay)
      ]
    );
  ...
  try_estimateBorrowRatePerBlockAfterChange(
    change: BigInt,
    repay: boolean
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
  ...
  estimateSupplyRatePerBlockAfterChange(
    ...
    let result = super.call(
      "estimateSupplyRatePerBlockAfterChange",
      "estimateSupplyRatePerBlockAfterChange(uint256,bool):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(change),
        ethereum.Value.fromBoolean(repay)
      ]
  ...
  try_estimateSupplyRatePerBlockAfterChange(
    change: BigInt,
    repay: boolean
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
  ...
  flashFeeBips(): BigInt {
    let result = super.call("flashFeeBips", "flashFeeBips():(uint256)", []);

    return result[0].toBigInt();
  }

  try_flashFeeBips(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("flashFeeBips", "flashFeeBips():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getAccountSnapshot(account: Address): cyToken__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new cyToken__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<cyToken__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new cyToken__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  isCollateralTokenInit(param0: Address): boolean {
    let result = super.call(
      "isCollateralTokenInit",
      "isCollateralTokenInit(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try_isCollateralTokenInit(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isCollateralTokenInit",
      "isCollateralTokenInit(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
  ...
  maxFlashLoan(): BigInt {
    let result = super.call("maxFlashLoan", "maxFlashLoan():(uint256)", []);

    return result[0].toBigInt();
  }

  try_maxFlashLoan(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("maxFlashLoan", "maxFlashLoan():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  registerCollateral(account: Address): BigInt {
    let result = super.call(
      "registerCollateral",
      "registerCollateral(address):(uint256)",
      [ethereum.Value.fromAddress(account)]
    );
  ...
  try_registerCollateral(account: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "registerCollateral",
      "registerCollateral(address):(uint256)",
      [ethereum.Value.fromAddress(account)]
  ...
  totalCollateralTokens(): BigInt {
    let result = super.call(
      "totalCollateralTokens",
      "totalCollateralTokens():(uint256)",
      []
    );
  ...
  try_totalCollateralTokens(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalCollateralTokens",
      "totalCollateralTokens():(uint256)",
      []
...
export class _setCollateralCapCall extends ethereum.Call {
  get inputs(): _setCollateralCapCall__Inputs {
    return new _setCollateralCapCall__Inputs(this);
  }

  get outputs(): _setCollateralCapCall__Outputs {
    return new _setCollateralCapCall__Outputs(this);
  }
}

export class _setCollateralCapCall__Inputs {
  _call: _setCollateralCapCall;

  constructor(call: _setCollateralCapCall) {
    this._call = call;
  }

  get newCollateralCap(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class _setCollateralCapCall__Outputs {
  _call: _setCollateralCapCall;
...
export class RegisterCollateralCall extends ethereum.Call {
  get inputs(): RegisterCollateralCall__Inputs {
    return new RegisterCollateralCall__Inputs(this);
  }

  get outputs(): RegisterCollateralCall__Outputs {
    return new RegisterCollateralCall__Outputs(this);
  }
}

export class RegisterCollateralCall__Inputs {
  _call: RegisterCollateralCall;

  constructor(call: RegisterCollateralCall) {
    this._call = call;
  }
...
export class RegisterCollateralCall__Outputs {
  _call: RegisterCollateralCall;
...
export class UnregisterCollateralCall extends ethereum.Call {
  get inputs(): UnregisterCollateralCall__Inputs {
    return new UnregisterCollateralCall__Inputs(this);
  }

  get outputs(): UnregisterCollateralCall__Outputs {
    return new UnregisterCollateralCall__Outputs(this);
  }
}

export class UnregisterCollateralCall__Inputs {
  _call: UnregisterCollateralCall;

  constructor(call: UnregisterCollateralCall) {
    this._call = call;
  }
...
export class UnregisterCollateralCall__Outputs {
  _call: UnregisterCollateralCall;
