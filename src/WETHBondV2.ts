...
import {  DepositCall, RedeemCall  } from '../generated/WETHBond/BondDepository'
import { Deposit } from '../generated/schema'
import { loadOrCreateTransaction } from "./utils/Transactions"
import { loadOrCreateOHMie, updateOhmieBalance } from "./utils/OHMie"
import { toDecimal } from "./utils/Decimals"
import { WETHBOND_TOKEN } from './utils/Constants'
...
export function handleDeposit(call: DepositCall): void {
  ...
  let token = loadOrCreateToken(WETHBOND_TOKEN)
...
export function handleRedeem(call: RedeemCall): void {
  ...
  redemption.token = loadOrCreateToken(WETHBOND_TOKEN).id;
